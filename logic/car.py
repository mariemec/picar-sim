...
class Car:
    ...
    def __init__(self, map, x=0, y=0, orientation=0, speed_factor=0, v_max=0.1, refresh_rate=24):
        self.position = Position(x, y)
        self.orientation = orientation
        self.speed_factor = speed_factor
        self.refresh_rate = refresh_rate
        self.speed = (self.speed_factor / 100) / (1 / self.refresh_rate)
        self.line_follower = LineFollower(self.position, map, v_max, self.refresh_rate)
